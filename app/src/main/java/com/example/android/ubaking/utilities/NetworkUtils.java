...
public final class NetworkUtils {
    ...
    private static final String STATIC_RECIPE_BASE_URL =
            "https://d17h27t6h515a5.cloudfront.net/topher/2017/May/59121517_baking/baking.json";


    /**
     * This method will return the URL to get recipe data
     *
     * @return
     */
    public static URL buildUrlForRecipeData() {

        Uri builtUri;

        // Build URL to retrieve movie Details
        builtUri = Uri.parse(STATIC_RECIPE_BASE_URL)
                .buildUpon()
                .build();
