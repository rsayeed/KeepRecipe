...
import com.example.android.ubaking.data.RecipeDbHelper;
...
public class DatabaseTest {
    ...
    /* Context used to perform operations on the database and create RecipeDbHelper */
    private final Context mContext = InstrumentationRegistry.getTargetContext();
    /* Class reference to help load the constructor on runtime */
    private final Class mDbHelperClass = RecipeDbHelper.class;
    ...
    public void create_database_test() throws Exception{
        ...
        assertEquals("Error: Your database was created without the expected tables.",
                RecipeContract.RecipeEntry.TABLE_NAME, tableNameCursor.getString(0));
    ...
    public void insert_single_record_test() throws Exception{
        ...
        testValues.put(RecipeContract.RecipeEntry.COLUMN_RECIPE_NAME, "Chocolate Pie");
        testValues.put(RecipeContract.RecipeEntry.COLUMN_RECIPE_SERVING, "2");
    ...
    void deleteTheDatabase(){
        try {
            ...
            fail("Make sure you have a member called DATABASE_NAME in the RecipeDbHelper");
        }catch (Exception ex){
            fail(ex.getMessage());
        }
